...
setTimeout(function()
    {
       document.getElementById("bdash1").style.visibility="visible"; 
    },2000);
...
function addpzt1(){
    ...
    document.getElementById("pzt1").style.animation="movepiler11 2s forwards";
    document.getElementById("pzt1").style.visibility="visible";
    document.getElementById("addpzt1").style.visibility="hidden";
    document.getElementById("arrowpzt1").style.visibility="hidden";
    ...
    document.getElementById("p_size").style.visibility="visible";

    document.getElementById("addbond1").style.visibility="visible";
    document.getElementById("arrowbond1").style.visibility="visible";    
    // document.getElementById("transpiler2").style.visibility="visible";
    // document.getElementById("arrowtrans2").style.visibility="visible";
...
function movebeam1(){
    ...
    {  
        document.getElementById("addpzt1").style.visibility="visible";
    document.getElementById("arrowpzt1").style.visibility="visible";

    document.getElementById("a_size").style.visibility="visible";
...
function flippzt1()
{
    ...
    document.getElementById("fpzt1").style.animation="flippzt2 2s forwards";
    document.getElementById("transpzt1").style.visibility="hidden";
    document.getElementById("arrowboxpzt1").style.visibility="hidden";

    setTimeout(function()
    {
        document.getElementById("fpzt2").style.visibility="visible";
    ...
    setTimeout(function()
    {
        ...
        document.getElementById("arrowbrush1").style.visibility="visible";
        document.getElementById("arrowtbond1").style.visibility="visible";


    },2000);
    // document.getElementById("pzt1").style.animation="flippzt2 2s forwards";
    /*
    document.getElementById("addbond1").style.visibility="hidden";
    document.getElementById("arrowbond1").style.visibility="hidden";
setTimeout(function()
...
function bondaply1()
{
    ...
    document.getElementById("brushbox1").style.animation="brushpzt2 3.8s forwards";
...
setTimeout(function()
    {
        document.getElementById("fpzteff2").style.visibility="visible";
        document.getElementById("fpzteff2").style.animation="brushgrese3 1.8s forwards";  
    },2000);
    document.getElementById("tbond1").style.visibility="hidden";
   
    document.getElementById("arrowbrush1").style.visibility="hidden";
setTimeout(function()
    {

        document.getElementById("fpzteff").style.visibility="visible";
        document.getElementById("fpzteff1").style.visibility="hidden";
        document.getElementById("fpzteff2").style.visibility="hidden";
        // document.getElementById("transpzt2").style.visibility="visible";
        document.getElementById("moveflipzt2").style.visibility="visible";
        document.getElementById("arrowboxpzt2").style.visibility="visible";

        document.getElementById("step3b").style.visibility="hidden";
...
//     document.getElementById("fpzt2").style.animation="flippzt3 2s forwards";
//     document.getElementById("transpzt2").style.visibility="hidden";
//     document.getElementById("arrowboxpzt2").style.visibility="hidden";

//     setTimeout(function()
//     {

//         document.getElementById("fpzt1").style.visibility="hidden";
//         document.getElementById("fpzteff").style.visibility="hidden";
//         document.getElementById("fpzt2").src="images/tt_pzt2.png";
//         // document.getElementById("fpzt1").style.visibility="visible";
...
function moveflippzt2()
{
    document.getElementById("moveflipzt2").style.visibility="hidden";
    document.getElementById("fpzt1").style.visibility="hidden";
    document.getElementById("fpzt2").style.animation="moveflippzt11 2s forwards";
    document.getElementById("fpzteff").style.animation="moveflippztg11 2s forwards";
    document.getElementById("arrowboxpzt2").style.visibility="hidden";
    setTimeout(function()
    {
        document.getElementById("fpzt2").style.visibility="hidden";
        document.getElementById("fpzteff").style.visibility="hidden";    
        document.getElementById("fpzt3").style.visibility="visible";
    },2000);

    setTimeout(function()
    {
        document.getElementById("fpzt3").style.animation="flippzt3 2s forwards";

    setTimeout(function()
    {
        document.getElementById("fpzt3").src="images/tt_pzt2.png";
        document.getElementById("nextbondeye").style.visibility="visible";
        document.getElementById("bondeyearrow3").style.visibility="visible";

        document.getElementById("step3c").style.visibility="hidden";
...
function showzoom1()
{
    // document.getElementById("bdash1").style.visibility="hidden";
    document.getElementById("bigzoom").style.visibility="visible";
    document.getElementById("bdash2").style.visibility="visible";
    setTimeout(function()
    {
